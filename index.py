...
#         print(f"| {country:<20} | {quarters.get('Q1', 0):<9.2f} | {quarters.get('Q2', 0):<9.2f} | {quarters.get('Q3', 0):<9.2f} | {quarters.get('Q4', 0):<9.2f} | {total_sales:<11.2f} |")
#     print("|______________________|___________|___________|___________|___________|____________|")
